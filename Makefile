...
all: pingd_server pingd_client_linux pingd_client_bsd
...
bin/pingd_client_bsd: client/pingd_client_bsd.cpp
	@mkdir -p bin
	$(CC) -target x86_64-unknown-freebsd12.2 --sysroot=/opt/cross-freebsd-12/ -pthread -o bin/pingd_client_bsd client/pingd_client_bsd.cpp

pingd_client_bsd: bin/pingd_client_bsd
